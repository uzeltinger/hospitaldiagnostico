...
class Stay extends MainController {
    protected $page = 'Stay';
    protected $tpl = 'pages:stay.html';
    ...
    public function index() {
        ...
        //Second Title (id: 12741)
        $secondTitle = $api->getTexto(12741);
        $vars['secondTitleTitle'] = $secondTitle->get('titulo'); 
        $vars['secondTitleCuerpo'] = $secondTitle->get('cuerpo');


        //Stay  First Title (id: 12738)
        $firstTitle = $api->getTexto(12738);
